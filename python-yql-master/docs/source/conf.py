# -*- coding: utf-8 -*-
#
# Python YQL documentation build configuration file, created by
...
# of the sidebar.
html_logo = "_static/python-yql.png"
...
html_use_opensearch = 'http://python-yql.org/'

# If nonempty, this is the file name suffix for HTML files (e.g. ".xhtml").
#html_file_suffix = ''

# Output file base name for HTML help builder.
htmlhelp_basename = 'PythonYQLdoc'
...
latex_documents = [
  ('index', 'PythonYQL.tex', u'Python YQL Documentation',
   u'Stuart Colville', 'manual'),
]
